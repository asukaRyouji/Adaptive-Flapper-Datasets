...
currentCase.Filename = '0715_pitch_300_16.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 300;
currentCase.Strike = 884;
currentCase.windEnd = 2646;
currentCase.txPeak = 993;
currentCase.xPeak = 0.220;
currentCase.tzPeak = 1035;
currentCase.zPeak = 0.110;
currentCase.stableInterval = [1436, 2600];
...
currentCase = intensityData;
currentCase.Filename = '0715_pitch_300_18.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 300;
currentCase.Strike = 862;
currentCase.windEnd = 2646;
currentCase.txPeak = 1011;
currentCase.xPeak = 0.189;
currentCase.tzPeak = 1199;
currentCase.zPeak = 0.097;
currentCase.stableInterval = [1400, 2773];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
pitch_300_18 = currentCase;

%% Kp_x = 1.5 kFFx = 20.0

currentCase = intensityData;
currentCase.Filename = '0715_pitch_300_20.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 300;
currentCase.Strike = 862;
currentCase.windEnd = 2646;
currentCase.txPeak = 900;
currentCase.xPeak = 0.196;
currentCase.tzPeak = 1038;
currentCase.zPeak = 0.093;
currentCase.stableInterval = [1346, 2400];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
pitch_300_20 = currentCase;

%% Kp_x = 1.5 kFFx = 25.0

currentCase = intensityData;
currentCase.Filename = '0715_pitch_300_25.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 300;
currentCase.Strike = 973;
currentCase.windEnd = 2646;
currentCase.txPeak = 1035;
currentCase.xPeak = 0.155;
currentCase.tzPeak = 1154;
currentCase.zPeak = 0.113;
currentCase.stableInterval = [1659, 2666];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
