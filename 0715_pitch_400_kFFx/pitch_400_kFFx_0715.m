...
currentCase.Filename = '0715_pitch_400_16.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 800;
currentCase.windEnd = 2646;
currentCase.txPeak = 917;
currentCase.xPeak = 0.382;
currentCase.tzPeak = 992;
currentCase.zPeak = 0.146;
currentCase.stableInterval = [1327, 2500];
...
pitch_400_16 = currentCase;

%% Kp_x = 1.5 kFFx = 16.0

currentCase = intensityData;
currentCase.Filename = '0715_pitch_400_18.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 800;
currentCase.windEnd = 2646;
currentCase.txPeak = 955;
currentCase.xPeak = 0.330;
currentCase.tzPeak = 1056;
currentCase.zPeak = 0.139;
currentCase.stableInterval = [1377, 2460];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
figure(2);
sgtitle('Kp_{x} = 1.5 k_{FF_{x}} = 18.0');
...
pitch_400_18 = currentCase;

%% Kp_x = 1.5 kFFx = 19.0

currentCase = intensityData;
currentCase.Filename = '0715_pitch_400_19_1.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 400;
currentCase.Strike = 750;
currentCase.windEnd = 2646;
currentCase.txPeak = 880;
currentCase.xPeak = 0.383;
currentCase.tzPeak = 961;
currentCase.zPeak = 0.136;
currentCase.stableInterval = [1400, 2400];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
figure(3);
sgtitle('Kp_{x} = 1.5 k_{FF_{x}} = 19.0');
...
pitch_400_19 = currentCase;

%% Kp_x = 1.5 kFFx = 20.0

currentCase = intensityData;
currentCase.Filename = '0715_pitch_400_20_1.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 800;
currentCase.Strike = 1100;
currentCase.windEnd = 2646;
currentCase.txPeak = 908;
currentCase.xPeak = 0.365;
currentCase.tzPeak = 1056;
currentCase.zPeak = 0.167;
currentCase.stableInterval = [1560, 2500];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
pitch_400_20 = currentCase;

%% Kp_x = 1.5 kFFx = 25.0

currentCase = intensityData;
currentCase.Filename = '0715_pitch_400_25.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 300;
currentCase.Strike = 860;
currentCase.windEnd = 2646;
currentCase.txPeak = 1099;
currentCase.xPeak = 0.441;
currentCase.tzPeak = 1184;
currentCase.zPeak = 0.260;
currentCase.stableInterval = [1351, 2831];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
