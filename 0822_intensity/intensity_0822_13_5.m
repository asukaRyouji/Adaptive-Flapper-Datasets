...
%% pwm = 200-700 1.34s adaptive2 flight 1

currentCase = intensityData;
currentCase.Filename = '0822_intensity_700_ad2_13_5_1.csv';
...
currentCase.stableInterval = [1166, 2766];
...
figure(1);
sgtitle('pwm = 700 adaptive T = 1.34s');
...
intensity_700_ad2_13_5_1 = currentCase;

%% pwm = 200-700 1.34s adaptive2 flight 2
...
currentCase.tzPeak = 1063;
currentCase.zPeak = 0.200;
currentCase.stableInterval = [1173, 2975];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
currentCase.rmseZ = sqrt(mean((currentCase.posZ(currentCase.stableInterval(1):currentCase.stableInterval(2))-(currentCase.stabPosZ+1.1)).^2));
%currentCase.rmseOtPitch = sqrt(mean((currentCase.otPitch(currentCase.stableInterval(1):currentCase.stableInterval(2))-(currentCase.filtOtPitch(currentCase.stableInterval(1):currentCase.stableInterval(2)))).^2));
currentCase.rmseOtPitch = sqrt(mean((currentCase.filtOtPitch(1250:2989)-mean(currentCase.filtOtPitch(1250:2989))).^2));

currentCase.filtCurrent = movAver(currentCase.filtCurrent, window_movAvg);
currentCase.stabCurrent = mean(movAver(currentCase.filtCurrent(currentCase.stableInterval(1):currentCase.stableInterval(2)), window_movAvg));

figure(2);
sgtitle('pwm = 700 adaptive2 T = 1.34s');
...
%% pwm = 200-700 1.34s adaptive2 flight 3
...
currentCase.tzPeak = 1063;
currentCase.zPeak = 0.200;
currentCase.stableInterval = [963, 3028];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
intensity_700_na_13_1 = currentCase;

%% pwm = 200-700 1.34s none adaptive
...
currentCase.tzPeak = 1063;
currentCase.zPeak = 0.200;
currentCase.stableInterval = [540, 1551];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
currentCase.rmseZ = sqrt(mean((currentCase.posZ(currentCase.stableInterval(1):currentCase.stableInterval(2))-(currentCase.stabPosZ+1.1)).^2));
%currentCase.rmseOtPitch = sqrt(mean((currentCase.otPitch(currentCase.stableInterval(1):currentCase.stableInterval(2))-(currentCase.filtOtPitch(currentCase.stableInterval(1):currentCase.stableInterval(2)))).^2));
currentCase.rmseOtPitch = sqrt(mean((currentCase.filtOtPitch(748:1477)-mean(currentCase.filtOtPitch(748:1477))).^2));

currentCase.filtCurrent = movAver(currentCase.filtCurrent, window_movAvg);
currentCase.stabCurrent = mean(movAver(currentCase.filtCurrent(currentCase.stableInterval(1):currentCase.stableInterval(2)), window_movAvg));

figure(4);
sgtitle('pwm = 700 nonead T = 1.34s');
...
intensity_700_na_13_2 = currentCase;
