...
%% pwm = 200-700 3s adaptive2 flight 1
...
currentCase.stableInterval = [737, 1575];
...
currentCase.rmseOtPitch = sqrt(mean((currentCase.filtOtPitch(593:1609)-mean(currentCase.filtOtPitch(593:1609))).^2));
...
%% pwm = 200-700 3s adaptive2 flight 2

currentCase = intensityData;
currentCase.Filename = '0822_intensity_700_ad2_3_5_2.csv';
currentCase.startPwm = 200;
currentCase.peakPwm = 700;
currentCase.Strike = 820;
currentCase.windEnd = 3700;
...
currentCase.tzPeak = 1063;
currentCase.zPeak = 0.200;
currentCase.stableInterval = [875, 2765];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
figure(2);
sgtitle('pwm = 700 adaptive2 T = 3s');
...
intensity_700_ad2_3_5_2 = currentCase;

%% pwm = 200-700 3s adaptive2 flight 3

currentCase = intensityData;
currentCase.Filename = '0822_intensity_700_ad2_3_5_3.csv';
currentCase.startPwm = 200;
currentCase.peakPwm = 700;
currentCase.Strike = 820;
currentCase.windEnd = 3700;
...
currentCase.tzPeak = 1063;
currentCase.zPeak = 0.200;
currentCase.stableInterval = [535, 1643];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
intensity_700_ad2_3_5_3 = currentCase;

%% pwm = 200-700 3s adaptive2 flight 4

currentCase = intensityData;
currentCase.Filename = '0822_intensity_700_ad2_3_5_4.csv';
currentCase.startPwm = 200;
currentCase.peakPwm = 700;
currentCase.Strike = 820;
currentCase.windEnd = 3700;
...
currentCase.tzPeak = 1063;
currentCase.zPeak = 0.200;
currentCase.stableInterval = [462, 1453];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
intensity_700_ad2_3_5_4 = currentCase;
...
currentCase.tzPeak = 1063;
currentCase.zPeak = 0.200;
currentCase.stableInterval = [795, 2819];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
currentCase.rmseZ = sqrt(mean((currentCase.posZ(currentCase.stableInterval(1):currentCase.stableInterval(2))-(currentCase.stabPosZ+1.1)).^2));
% currentCase.rmseOtPitch = sqrt(mean((currentCase.otPitch(currentCase.stableInterval(1):currentCase.stableInterval(2))-(currentCase.filtOtPitch(currentCase.stableInterval(1):currentCase.stableInterval(2)))).^2));
currentCase.rmseOtPitch = sqrt(mean((currentCase.filtOtPitch(1045:2731)-mean(currentCase.filtOtPitch(1045:2731))).^2));

currentCase.filtCurrent = movAver(currentCase.filtCurrent, window_movAvg);
currentCase.stabCurrent = mean(movAver(currentCase.filtCurrent(currentCase.stableInterval(1):currentCase.stableInterval(2)), window_movAvg));

figure(5);
sgtitle('pwm = 700 nonead T = 3s');
...
intensity_700_na_3 = currentCase;