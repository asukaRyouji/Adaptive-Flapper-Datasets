...
currentCase.Filename = '0721_pitch_400_18.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 400;
currentCase.Strike = 700;
currentCase.windEnd = 2646;
currentCase.txPeak = 850;
currentCase.xPeak = 0.390;
currentCase.tzPeak = 909;
currentCase.zPeak = 0.142;
currentCase.stableInterval = [1186, 2200];
...
currentCase = intensityData;
currentCase.Filename = '0721_pitch_400_185.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 1200;
currentCase.windEnd = 2646;
currentCase.txPeak = 1372;
currentCase.xPeak = 0.293;
currentCase.tzPeak = 1568;
currentCase.zPeak = 0.141;
currentCase.stableInterval = [1900, 3200];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
figure(2);
sgtitle('Kp_{x} = 1.5 k_{FF_{x}} = 18.5');
...
pitch_400_185 = currentCase;

%% Kp_x = 1.5 kFFx = 19.0

currentCase = intensityData;
currentCase.Filename = '0721_pitch_400_19.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 1018;
currentCase.windEnd = 2646;
currentCase.txPeak = 1165;
currentCase.xPeak = 0.342;
currentCase.tzPeak = 1221;
currentCase.zPeak = 0.125;
currentCase.stableInterval = [2000, 3000];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
