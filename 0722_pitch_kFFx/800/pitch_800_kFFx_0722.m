...
currentCase.Filename = '0722_pitch_800_225.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 400;
currentCase.Strike = 442;
currentCase.windEnd = 2646;
currentCase.txPeak = 525;
currentCase.xPeak = 0.624;
currentCase.tzPeak = 554;
currentCase.zPeak = 0.385;
currentCase.stableInterval = [646, 1375];
...
pitch_800_225 = currentCase;

%% Kp_x = 1.5 kFFx = 23.0

currentCase = intensityData;
currentCase.Filename = '0722_pitch_800_23.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 608;
currentCase.windEnd = 2646;
currentCase.txPeak = 685;
currentCase.xPeak = 0.563;
currentCase.tzPeak = 718;
currentCase.zPeak = 0.325;
currentCase.stableInterval = [1000, 1800];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
pitch_800_23 = currentCase;

%% Kp_x = 1.5 kFFx = 24.0

currentCase = intensityData;
currentCase.Filename = '0722_pitch_800_24.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 700;
currentCase.Strike = 746;
currentCase.windEnd = 2646;
currentCase.txPeak = 865;
currentCase.xPeak = 0.633;
currentCase.tzPeak = 930;
currentCase.zPeak = 0.291;
currentCase.stableInterval = [1064, 2500];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
pitch_800_24 = currentCase;

%% Kp_x = 1.5 kFFx = 25.0

currentCase = intensityData;
currentCase.Filename = '0722_pitch_800_25.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 600;
currentCase.Strike = 349;
currentCase.windEnd = 2646;
currentCase.txPeak = 409;
currentCase.xPeak = 0.681;
currentCase.tzPeak = 435;
currentCase.zPeak = 0.313;
currentCase.stableInterval = [517, 1235];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
figure(4);
sgtitle('Kp_{x} = 1.5 k_{FF_{x}} = 25.0');
...
pitch_800_25 = currentCase;

%% Kp_x = 1.5 kFFx = 26.0

currentCase = intensityData;
currentCase.Filename = '0722_pitch_800_26.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 600;
currentCase.Strike = 416;
currentCase.windEnd = 2646;
currentCase.txPeak = 488;
currentCase.xPeak = 0.694;
currentCase.tzPeak = 518;
currentCase.zPeak = 0.354;
currentCase.stableInterval = [668, 1297];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
figure(5);
sgtitle('Kp_{x} = 1.5 k_{FF_{x}} = 26.0');
