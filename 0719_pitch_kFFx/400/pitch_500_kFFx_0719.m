...
currentCase.Filename = '0719_pitch_500_18.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 850;
currentCase.windEnd = 2646;
currentCase.txPeak = 1029;
currentCase.xPeak = 0.373;
currentCase.tzPeak = 1079;
currentCase.zPeak = 0.177;
currentCase.stableInterval = [2400, 3000];
...
pitch_500_18 = currentCase;

%% Kp_x = 1.5 kFFx = 19.0

currentCase = intensityData;
currentCase.Filename = '0719_pitch_500_19.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 1044;
currentCase.windEnd = 2646;
currentCase.txPeak = 1247;
currentCase.xPeak = 0.338;
currentCase.tzPeak = 1304;
...
pitch_500_19 = currentCase;

%% Kp_x = 1.5 kFFx = 20.0

currentCase = intensityData;
currentCase.Filename = '0719_pitch_500_20_1.csv';
currentCase.startPwm = 0;
currentCase.peakPwm = 500;
currentCase.Strike = 1018;
currentCase.windEnd = 2646;
currentCase.txPeak = 1192;
currentCase.xPeak = 0.360;
currentCase.tzPeak = 1258;
currentCase.zPeak = 0.173;
currentCase.stableInterval = [2160, 3330];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
...
pitch_500_20 = currentCase;

%% Kp_x = 1.5 kFFx = 19.5

currentCase = intensityData;
currentCase.Filename = '0719_pitch_500_195.csv';
currentCase.peakPwm = 500;
currentCase.Strike = 990;
currentCase.windEnd = 2646;
currentCase.txPeak = 1158;
currentCase.xPeak = 0.323;
currentCase.tzPeak = 1305;
currentCase.zPeak = 0.182;
currentCase.stableInterval = [1900, 3300];
currentCase.Pot = currentCase.readPot();
currentCase.Pot = currentCase.Pot(3:end);
currentCase.airVolt = currentCase.readAirVolt();
currentCase.airVolt = currentCase.airVolt(3:end);
